...
{
    /// <summary>
    /// This class is a helper class allowing management of observers for different logical entities
    ...
    {
        /// <summary>
        /// Event delegate for list observers - it's called whenever there may be a need to update the presentation
        ...
        /// If there are no observers for a specific entity instance - there will not be an entry in the hash
        ...
        /// <summary>
        /// Add an observer on change in the list of entities that may affect the list presentation.
        /// </summary>
        ...
        /// <summary>
        /// Remove an observer on change in the list of entities that may affect the list presentation.
        /// </summary>
        ...
        /// <summary>
        /// Add an observer on change in an instance of an entity that may affect the entity instance presentation.
        /// </summary>
        ...
        /// <summary>
        /// Remove an observer on change in an instance of an entity that may affect the entity instance presentation.
        /// </summary>
        ...
        internal void RemoveObserver(int id, Action observer)
        {
            ...
            if (_specificObservers.ContainsKey(id) && _specificObservers[id] is not null)
            {
                ...
                if (specificObserver?.GetInvocationList().Length == 0) // If there are no more observers for the ID
                    ...
                    _specificObservers[id] = specificObserver; // Update the delegate
            }
        }
