...
public interface ICall
{
    ...
    public IEnumerable<BO.ClosedCallInList> RequestClosedCallsByVolunteer(int volunteerId, BO.CallType? filterBy, BO.CallField? sortBy);
    ...
    /// <param name="filterBy">Filter by call type (nullable).</param>
    /// <param name="sortBy">Sort the list by a specific field (nullable).</param>
    public IEnumerable<BO.OpenCallInList> RequestOpenCallsForSelection(int volunteerId, BO.CallType? filterBy, BO.CallField? sortBy);
